<section id="section_5" class="h-full w-full relative flex flex-col justify-center bg-[#0a0823]">
    <div class="flex justify-center items-center flex-col flex-wrap">
        <div class="text-white w-full md:w-[63%] max-w-[63%] py-10">
            <ul
                class="flex items-center justify-center roboto font-normal text-[14px] md:text-[16px] lg:text-[18px] flex-wrap gap-8">
    ...
    <div class="flex justify-center flex-col tablet:flex-row items-center gap-5 w-[63%] h-full mx-auto">
        <div class="w-full h-full basis-[40%]">
            <div class="w-full relative flex items-center">
                <span class="absolute px-3 text-3xl"><i class="fa-solid fa-globe"></i></span>
                <select class="bg-white font-medium px-12 py-3 w-full md:w-80 rounded-xl text-[#1C0949]">
                    <option value="English">English</option>
                </select>
            </div>
        </div>
        <div class="w-full h-full basis-[40%] flex justify-center gap-3">
            <div class="w-full tablet:w-44 h-12 p-2 flex items-center bg-white rounded-xl">
        ...
        <div class="w-full h-full basis-[20%] flex justify-between">
            <div class="flex items-center gap-3 text-white mx-auto">
                <a href="https://www.instagram.com/airdrumming/profilecard/?igsh=MTY5Y3dieHl0eTZkOA=="><svg width="37" height="36" viewBox="0 0 37 36" fill="none"
                ...
                <a href="https://www.tiktok.com/@airdrumming?_t=8rXPEEW7i1R&_r=1"><svg width="36" height="36" viewBox="0 0 36 36" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                <a href="https://t.me/airdrumming"><svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <mask id="mask0_1802_6819" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="2" y="2" width="36" height="36">
                    <path d="M2 2H38V38H2V2Z" fill="white"/>
                    </mask>
                    <g mask="url(#mask0_1802_6819)">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M35.5 20C35.5 28.836 28.336 36 19.5 36C10.664 36 3.5 28.836 3.5 20C3.5 11.164 10.664 4 19.5 4C28.336 4 35.5 11.164 35.5 20ZM20.0733 15.812C18.5178 16.4591 15.4076 17.7987 10.7427 19.8307C9.98533 20.132 9.58844 20.4267 9.552 20.7147C9.49067 21.2027 10.1013 21.3947 10.9307 21.6547L11.2813 21.7667C12.0987 22.032 13.1973 22.3427 13.768 22.3547C14.2862 22.3653 14.8649 22.152 15.504 21.7147C19.8613 18.7724 22.1107 17.2853 22.252 17.2533C22.352 17.2307 22.4907 17.2013 22.584 17.2853C22.6773 17.368 22.668 17.5253 22.6587 17.568C22.5973 17.8253 20.2053 20.0507 18.9653 21.2027C18.5787 21.5613 18.3053 21.816 18.2493 21.8747C18.1222 22.0036 17.9969 22.1276 17.8733 22.2467C17.1133 22.9773 16.5453 23.5267 17.9053 24.4227C18.5587 24.8533 19.0813 25.2093 19.6027 25.564C20.172 25.952 20.74 26.3387 21.476 26.8213C21.6627 26.9458 21.8427 27.0702 22.016 27.1947C22.6787 27.668 23.2747 28.092 24.0107 28.0253C24.4373 27.9853 24.88 27.584 25.104 26.3853C25.6333 23.5507 26.676 17.412 26.9173 14.8813C26.9333 14.6712 26.9244 14.46 26.8907 14.252C26.872 14.0837 26.79 13.9287 26.6613 13.8187C26.4707 13.6627 26.1747 13.6293 26.0413 13.632C25.44 13.6427 24.5173 13.964 20.0733 15.812Z" fill="#F9F9F9"/>
                    </g>
                    </svg>
                </a>
            </div>
